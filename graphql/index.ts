...
export type AddPullRequestReviewInput = {
	...
	threads?: Maybe<
		Array<Maybe<DraftPullRequestReviewThread>>
	>;
	/** A unique identifier for the client performing the mutation. */
	clientMutationId?: Maybe<Scalars['String']>;
};
...
export type BranchProtectionRuleConflictConnection = {
	...
	/** A list of edges. */
	edges?: Maybe<
		Array<Maybe<BranchProtectionRuleConflictEdge>>
	>;
	/** A list of nodes. */
...
export type CreatedPullRequestContribution =
	Contribution & {
...
export type CreatedPullRequestContributionConnection = {
	...
	/** A list of edges. */
	edges?: Maybe<
		Array<Maybe<CreatedPullRequestContributionEdge>>
	>;
	/** A list of nodes. */
	nodes?: Maybe<
		Array<Maybe<CreatedPullRequestContribution>>
	>;
	/** Information to aid in pagination. */
	pageInfo: PageInfo;
	/** Identifies the total count of items in the connection. */
...
export type CreatedPullRequestReviewContributionConnection =
	{
		...
		/** A list of edges. */
		edges?: Maybe<
			Array<Maybe<CreatedPullRequestReviewContributionEdge>>
		>;
		/** A list of nodes. */
		nodes?: Maybe<
			Array<Maybe<CreatedPullRequestReviewContribution>>
		>;
		/** Information to aid in pagination. */
		pageInfo: PageInfo;
		/** Identifies the total count of items in the connection. */
...
export type CreatedRepositoryContributionConnection = {
	...
	/** A list of edges. */
	edges?: Maybe<
		Array<Maybe<CreatedRepositoryContributionEdge>>
	>;
	/** A list of nodes. */
...
export type EnterpriseAdministratorInvitationConnection = {
	...
	/** A list of edges. */
	edges?: Maybe<
		Array<Maybe<EnterpriseAdministratorInvitationEdge>>
	>;
	/** A list of nodes. */
	nodes?: Maybe<
		Array<Maybe<EnterpriseAdministratorInvitation>>
	>;
	/** Information to aid in pagination. */
	pageInfo: PageInfo;
	/** Identifies the total count of items in the connection. */
...
export type EnterpriseOrganizationMembershipConnection = {
	...
	/** A list of edges. */
	edges?: Maybe<
		Array<Maybe<EnterpriseOrganizationMembershipEdge>>
	>;
	/** A list of nodes. */
...
export type EnterpriseOutsideCollaboratorConnection = {
	...
	/** A list of edges. */
	edges?: Maybe<
		Array<Maybe<EnterpriseOutsideCollaboratorEdge>>
	>;
	/** A list of nodes. */
	nodes?: Maybe<Array<Maybe<User>>>;
	/** Information to aid in pagination. */
...
export type EnterprisePendingCollaboratorConnection = {
	...
	/** A list of edges. */
	edges?: Maybe<
		Array<Maybe<EnterprisePendingCollaboratorEdge>>
	>;
	/** A list of nodes. */
	nodes?: Maybe<Array<Maybe<User>>>;
	/** Information to aid in pagination. */
...
export type EnterprisePendingMemberInvitationConnection = {
	...
	/** A list of edges. */
	edges?: Maybe<
		Array<Maybe<EnterprisePendingMemberInvitationEdge>>
	>;
	/** A list of nodes. */
...
export type EnterpriseServerInstallationConnection = {
	...
	/** A list of edges. */
	edges?: Maybe<
		Array<Maybe<EnterpriseServerInstallationEdge>>
	>;
	/** A list of nodes. */
...
export type EnterpriseServerUserAccountConnection = {
	...
	/** A list of edges. */
	edges?: Maybe<
		Array<Maybe<EnterpriseServerUserAccountEdge>>
	>;
	/** A list of nodes. */
...
export type EnterpriseServerUserAccountEmailConnection = {
	...
	/** A list of edges. */
	edges?: Maybe<
		Array<Maybe<EnterpriseServerUserAccountEmailEdge>>
	>;
	/** A list of nodes. */
	nodes?: Maybe<
		Array<Maybe<EnterpriseServerUserAccountEmail>>
	>;
	/** Information to aid in pagination. */
	pageInfo: PageInfo;
	/** Identifies the total count of items in the connection. */
...
export type EnterpriseServerUserAccountsUploadConnection = {
	...
	/** A list of edges. */
	edges?: Maybe<
		Array<Maybe<EnterpriseServerUserAccountsUploadEdge>>
	>;
	/** A list of nodes. */
	nodes?: Maybe<
		Array<Maybe<EnterpriseServerUserAccountsUpload>>
	>;
	/** Information to aid in pagination. */
	pageInfo: PageInfo;
	/** Identifies the total count of items in the connection. */
...
export type OrgRemoveMemberAuditEntry = Node &
	...
	OrganizationAuditEntryData & {
		...
		membershipTypes?: Maybe<
			Array<OrgRemoveMemberAuditEntryMembershipType>
		>;
		/** The corresponding operation type for the action */
		operationType?: Maybe<OperationType>;
		/** The Organization associated with the Audit Entry. */
...
export type RepositoryVulnerabilityAlertConnection = {
	...
	/** A list of edges. */
	edges?: Maybe<
		Array<Maybe<RepositoryVulnerabilityAlertEdge>>
	>;
	/** A list of nodes. */
 ...
 * request.
 */
export type ReviewStatusHovercardContext =
	HovercardContext & {
...
type GitHubActorPartial_EnterpriseUserAccount_Fragment = {
	__typename?: 'EnterpriseUserAccount';
} & Pick<
...
type GitHubActorPartial_Mannequin_Fragment = {
	__typename?: 'Mannequin';
} & Pick<Mannequin, 'avatarUrl' | 'url' | 'login'>;

type GitHubActorPartial_Organization_Fragment = {
	__typename?: 'Organization';
} & Pick<Organization, 'avatarUrl' | 'url' | 'login'>;

type GitHubActorPartial_User_Fragment = {
	__typename?: 'User';
...
type GitHubReactablePartial_CommitComment_Fragment = {
	__typename?: 'CommitComment';
} & {
	reactionGroups?: Maybe<
		Array<
			{ __typename?: 'ReactionGroup' } & Pick<
				ReactionGroup,
...
type GitHubReactablePartial_Discussion_Fragment = {
	__typename?: 'Discussion';
} & {
	reactionGroups?: Maybe<
		Array<
...
type GitHubReactablePartial_DiscussionComment_Fragment = {
	__typename?: 'DiscussionComment';
} & {
	reactionGroups?: Maybe<
		Array<
...
type GitHubReactablePartial_Issue_Fragment = {
	__typename?: 'Issue';
} & {
	reactionGroups?: Maybe<
		Array<
...
type GitHubReactablePartial_IssueComment_Fragment = {
	__typename?: 'IssueComment';
} & {
	reactionGroups?: Maybe<
		Array<
...
type GitHubReactablePartial_PullRequest_Fragment = {
	__typename?: 'PullRequest';
} & {
	reactionGroups?: Maybe<
		Array<
...
type GitHubReactablePartial_PullRequestReview_Fragment = {
	__typename?: 'PullRequestReview';
} & {
	reactionGroups?: Maybe<
		Array<
...
type GitHubReactablePartial_PullRequestReviewComment_Fragment =
	{ __typename?: 'PullRequestReviewComment' } & {
		reactionGroups?: Maybe<
			Array<
				{ __typename?: 'ReactionGroup' } & Pick<
...
type GitHubReactablePartial_Release_Fragment = {
	__typename?: 'Release';
} & {
	reactionGroups?: Maybe<
		Array<
...
type GitHubReactablePartial_TeamDiscussion_Fragment = {
	__typename?: 'TeamDiscussion';
} & {
	reactionGroups?: Maybe<
		Array<
...
type GitHubReactablePartial_TeamDiscussionComment_Fragment =
	{ __typename?: 'TeamDiscussionComment' } & {
		reactionGroups?: Maybe<
			Array<
				{ __typename?: 'ReactionGroup' } & Pick<
...
export type GitHubReactablePartialFragment =
	| GitHubReactablePartial_CommitComment_Fragment
	| GitHubReactablePartial_Discussion_Fragment
	| GitHubReactablePartial_DiscussionComment_Fragment
	| GitHubReactablePartial_Issue_Fragment
	| GitHubReactablePartial_IssueComment_Fragment
	| GitHubReactablePartial_PullRequest_Fragment
	| GitHubReactablePartial_PullRequestReview_Fragment
	| GitHubReactablePartial_PullRequestReviewComment_Fragment
	| GitHubReactablePartial_Release_Fragment
...
> & {
		...
		followers: { __typename?: 'FollowerConnection' } & Pick<
			FollowerConnection,
			'totalCount'
		>;
		following: { __typename?: 'FollowingConnection' } & Pick<
			FollowingConnection,
			'totalCount'
		>;
	};

export type GitHubUserOrgAssociationPartialFragment = {
	__typename?: 'Organization';
} & Pick<
	Organization,
	'id' | 'url' | 'email' | 'location' | 'name' | 'avatarUrl'
>;

export type GitHubUserStatusPartialFragment = {
	__typename?: 'UserStatus';
} & Pick<
	UserStatus,
	'message' | 'expiresAt' | 'id' | 'emoji' | 'createdAt'
>;

export type CommitCommentPartialFragment = {
	__typename?: 'CommitComment';
} & Pick<
	CommitComment,
	| 'body'
			...
			Array<
				Maybe<
					...
					> & {
							...
							reactions: {
								__typename?: 'ReactionConnection';
							} & GitHubReactionsPartialFragment;
						}
				>
			>
		>;
...
type GitHubPinnableItemPartial_Gist_Fragment = {
	__typename?: 'Gist';
};

type GitHubPinnableItemPartial_Repository_Fragment = {
	__typename?: 'Repository';
} & Pick<
	Repository,
	| 'id'
...
export type GitHubPinnableItemPartialFragment =
	| GitHubPinnableItemPartial_Gist_Fragment
	| GitHubPinnableItemPartial_Repository_Fragment;

export type GitHubReactionsPartialFragment = {
	__typename?: 'ReactionConnection';
...
export type GitHubRepoPartialFragment = {
	__typename?: 'Repository';
} & Pick<
	Repository,
	| 'name'
...
export type GitHubUserDetailPartialFragment = {
			...
			nodes?: Maybe<
				Array<
					Maybe<
						{
							__typename?: 'Organization';
						} & GitHubUserOrgAssociationPartialFragment
					>
				>
			>;
		};
	status?: Maybe<
		{
			__typename?: 'UserStatus';
		} & GitHubUserStatusPartialFragment
	>;
	pinnedItems: {
		__typename?: 'PinnableItemConnection';
...
} & GitHubUserAtomicPartialFragment;

export type GetRepoByLoginWithDetailsQueryVariables =
	Exact<{
		login: Scalars['String'];
		name: Scalars['String'];
	}>;

export type GetRepoByLoginWithDetailsQuery = {
	__typename?: 'Query';
} & {
	user?: Maybe<
		{ __typename?: 'User' } & {
			repository?: Maybe<
				{ __typename?: 'Repository' } & {
					commitComments: {
						__typename?: 'CommitCommentConnection';
					} & Pick<CommitCommentConnection, 'totalCount'> & {
							pageInfo: {
								__typename?: 'PageInfo';
							} & GitHubPageInfoPartialFragment;
							nodes?: Maybe<
										...
										> & {
												node?: Maybe<
													{ __typename?: 'Issue' } & {
														...
														comments: {
															__typename?: 'IssueCommentConnection';
														} & GitHubIssueCommentFieldsFragment;
			...
			>;
		} & GitHubUserDetailPartialFragment
	>;
};
...
export const GitHubLabelPartialFragmentDoc = gql`
...
`;
export const GitHubActorPartialFragmentDoc = gql`
	fragment GitHubActorPartial on Actor {
		avatarUrl(size: 250)
		url
		login
	}
`;
export const CommitCommentPartialFragmentDoc = gql`
	...
	${GitHubActorPartialFragmentDoc}
`;
export const GitHubPageInfoPartialFragmentDoc = gql`
...
`;
export const GitHubReactablePartialFragmentDoc = gql`
...
`;
export const GitHubReactionsPartialFragmentDoc = gql`
	...
	${GitHubPageInfoPartialFragmentDoc}
	${GitHubReactablePartialFragmentDoc}
`;
export const GitHubIssueCommentFieldsFragmentDoc = gql`
	...
	${GitHubPageInfoPartialFragmentDoc}
	${GitHubActorPartialFragmentDoc}
	${GitHubReactionsPartialFragmentDoc}
`;
export const GitHubIssuePartialFragmentDoc = gql`
	...
	${GitHubActorPartialFragmentDoc}
`;
export const GitHubLanguagePartialFragmentDoc = gql`
...
`;
export const GitHubLanguagesPartialFragmentDoc = gql`
...
`;
export const GitHubUserOrgAssociationPartialFragmentDoc = gql`
	fragment GitHubUserOrgAssociationPartial on Organization {
		id
		url
		email
		location
...
`;
export const GitHubPinnableItemPartialFragmentDoc = gql`
	...
	${GitHubLanguagePartialFragmentDoc}
`;
export const GitHubUserDetailPartialFragmentDoc = gql`
...
`;
export const GetRepoByLoginWithDetailsDocument = gql`
	...
	${GitHubUserDetailPartialFragmentDoc}
	${GitHubRepoPartialFragmentDoc}
	${GitHubPageInfoPartialFragmentDoc}
	${CommitCommentPartialFragmentDoc}
	${GitHubLanguagesPartialFragmentDoc}
	${GitHubLabelPartialFragmentDoc}
	${GitHubIssuePartialFragmentDoc}
	${GitHubReactionsPartialFragmentDoc}
	${GitHubIssueCommentFieldsFragmentDoc}
`;
...
export function getSdk(
	...
	return {
		getRepoByLoginWithDetails(
			variables: GetRepoByLoginWithDetailsQueryVariables,
			requestHeaders?: Dom.RequestInit['headers']
		): Promise<GetRepoByLoginWithDetailsQuery> {
			return withWrapper(
				wrappedRequestHeaders =>
					client.request<GetRepoByLoginWithDetailsQuery>(
						GetRepoByLoginWithDetailsDocument,
						variables,
		...
		getReposWithDetails(
			variables: GetReposWithDetailsQueryVariables,
			requestHeaders?: Dom.RequestInit['headers']
		): Promise<GetReposWithDetailsQuery> {
			return withWrapper(
				wrappedRequestHeaders =>
					client.request<GetReposWithDetailsQuery>(
...
export function getSdkWithHooks(
	...
	return {
		...sdk,
		useGetRepoByLoginWithDetails(
			variables: GetRepoByLoginWithDetailsQueryVariables,
			config?: SWRConfigInterface<
				GetRepoByLoginWithDetailsQuery,
				ClientError
			>
		) {
			return useSWR<
				...
				ClientError
			>(
				genKey<GetRepoByLoginWithDetailsQueryVariables>(
					'GetRepoByLoginWithDetails',
					variables
				),
				() => sdk.getRepoByLoginWithDetails(variables),
				config
			);
		},
		useGetReposWithDetails(
			variables: GetReposWithDetailsQueryVariables,
			config?: SWRConfigInterface<
			...
			return useSWR<GetReposWithDetailsQuery, ClientError>(
				genKey<GetReposWithDetailsQueryVariables>(
					'GetReposWithDetails',
					variables
				),
				() => sdk.getReposWithDetails(variables),
				config
			);
		}
	};
}
export type SdkWithHooks = ReturnType<
	typeof getSdkWithHooks
>;
